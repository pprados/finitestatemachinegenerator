...
{
       0,     0,     3,     8,     9,    11,    12,    15,    16,    18,
      21,    23,    25,    28,    30,    32,    34,    38,    39,    41,
      43,    46,    49,    50,    57,    59,    64,    65,    67,    71,
      72,    74,    78,    79
};
...
{
      18,     0,    -1,    20,     3,    24,    19,    -1,    -1,     3,
      -1,    -1,    20,    21,    -1,    -1,     4,    -1,     5,    10,
      -1,     7,    -1,     8,    -1,     6,    22,    -1,     9,    -1,
       1,    -1,    11,    -1,    22,    23,    11,    -1,    -1,    13,
      -1,    25,    -1,    24,    25,    -1,     1,    14,    -1,    -1,
      29,    15,    26,    28,    30,    27,    -1,    14,    -1,    16,
      28,    30,    27,    -1,    -1,    11,    -1,    28,    23,    11,
      -1,    -1,    10,    -1,    29,    23,    10,    -1,    -1,    12,
      -1
};
...
{
       0,   125,   125,   150,   151,   165,   166,   175,   176,   177,
     190,   194,   198,   199,   200,   212,   216,   228,   229,   238,
     239,   248,   251,   251,   437,   441,   463,   466,   478,   499,
     502,   514,   535,   538
};
#endif
...
{
  "$end", "error", "$undefined", "MARK", "CHEADER", "CSTART", "CEXTERN",
  "CPRIOEVENT", "CPRIOSTATE", "CMAX", "STATE", "EVENT", "EXECUTION", "','",
  "';'", "':'", "'|'", "$accept", "prg", "tail", "defs", "def", "nlist",
  "virgule", "rules", "rule", "@1", "rrule", "events", "states", "exec", 0
};
#endif
...
{
       5,     0,     0,     1,    14,     0,     8,     0,     0,    10,
      11,    13,     6,     0,    30,     0,    19,    17,     9,    15,
      12,    21,     4,     2,    20,    18,    22,     0,     0,    26,
      31,    16,    27,    32,    33,     0,     0,    28,    24,    26,
      23,    32,     0,    25
};
...
{
     -14,     5,    16,   -14,   -14,     1,   -14,    -1,     7,   -14,
     -14,   -14,   -14,    -2,   -14,     0,   -14,    -7,   -14,   -14,
      18,   -14,   -14,   -14,   -14,   -14,   -14,    20,    21,    23,
     -14,   -14,   -14,    15,   -14,    25,    19,   -14,   -14,    23,
     -14,    15,    19,   -14
};
...
{
      -3,    13,    13,    22,    27,     3,    25,    28,    26,    18,
      14,    14,    21,   -29,   -29,   -29,   -29,     4,    19,     5,
       6,     7,     8,     9,    10,    11,   -17,    34,    25,   -17,
      30,    25,    31,    38,    32,    39,    37,    24,    43,     0,
       0,    41,     0,     0,    42
};

static const yytype_int8 yycheck[] =
{
       0,     1,     1,     3,    17,     0,    13,    20,    15,    10,
      10,    10,    14,    13,    13,    15,    15,     1,    11,     3,
       4,     5,     6,     7,     8,     9,    11,    12,    13,    11,
      10,    13,    11,    14,    11,    16,    11,    15,    42,    -1,
      -1,    39,    -1,    -1,    41
};
...
{
       0,    18,    20,     0,     1,     3,     4,     5,     6,     7,
       8,     9,    21,     1,    10,    24,    25,    29,    10,    11,
      22,    14,     3,    19,    25,    13,    15,    23,    23,    26,
      10,    11,    11,    28,    12,    23,    30,    11,    14,    16,
      27,    28,    30,    27
};
...
#line 178 "./autoyacc.y"
    {
		...
		{
			fsm.start_state=(yyvsp[(2) - (2)].state);
...
#line 213 "./autoyacc.y"
    {
		chg_event((yyvsp[(1) - (1)].event)); 	/* convertie en extern */
	}
    break;
...
#line 252 "./autoyacc.y"
    {
		...
		dinc(yacc);
		ADD_TEMP(rrule);
		rrule->levent=(yyvsp[(4) - (6)].levent);
		rrule->exe=(yyvsp[(5) - (6)].exe);
		rrule->next=(yyvsp[(6) - (6)].rrule);
...
#line 442 "./autoyacc.y"
    {
	if (((yyval.rrule)=malloc(sizeof(*(yyval.rrule))))==NULL)
	{
		fsm_fatal(fsm.namei,fsm.lineno,ERR_MEMORY);
		YYERROR;
	}
	dinc(yacc);
	ADD_TEMP((yyval.rrule));
	(yyval.rrule)->levent=(yyvsp[(2) - (4)].levent);
	(yyval.rrule)->exe=(yyvsp[(3) - (4)].exe);
	(yyval.rrule)->next=(yyvsp[(4) - (4)].rrule);
}
    break;
...
#line 467 "./autoyacc.y"
    {
		if (((yyval.levent)=malloc(sizeof(*(yyval.levent))))==NULL)
		{
			fsm_fatal(fsm.namei,fsm.lineno,ERR_MEMORY);
			YYERROR;
		}
		dinc(yacc);
		ADD_TEMP((yyval.levent));
		(yyval.levent)->event=(yyvsp[(1) - (1)].event);
		(yyval.levent)->next=NULL;
	}
    break;
...
#line 479 "./autoyacc.y"
    {
		...
		dinc(yacc);
		ADD_TEMP((yyval.levent));
		(yyval.levent)->event=(yyvsp[(3) - (3)].event);
		(yyval.levent)->next=(yyvsp[(1) - (3)].levent);
	}
    break;
...
#line 503 "./autoyacc.y"
    {
		if (((yyval.lstate)=malloc(sizeof(*(yyval.lstate))))==NULL)
		{
			fsm_fatal(fsm.namei,fsm.lineno,ERR_MEMORY);
			YYERROR;
		}
		dinc(yacc);
		ADD_TEMP((yyval.lstate));
		(yyval.lstate)->state=(yyvsp[(1) - (1)].state);
		(yyval.lstate)->next=NULL;
	}
    break;
...
#line 515 "./autoyacc.y"
    {
		...
		dinc(yacc);
		ADD_TEMP((yyval.lstate));
		(yyval.lstate)->state=(yyvsp[(3) - (3)].state);
		(yyval.lstate)->next=(yyvsp[(1) - (3)].lstate);
	}
    break;
...
#line 539 "./autoyacc.y"
    {
		(yyval.exe)=(yyvsp[(1) - (1)].exe);
	}
    break;


/* Line 1267 of yacc.c.  */
#line 1837 "autoyacc.c"
      default: break;
    }
